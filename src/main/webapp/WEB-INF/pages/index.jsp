...
<html>
    ...
    <body>
        ...
        <script>
            ...
            // тоїсть при нажатии на кнопку що зверху
            // Add Contact id="add_contact"  тут це - '#add_contact'
            // спрацює jsp сторінка '/contact_add_page'
            // а там на contact_add_page.jsp  перекине постом на
            // контролер метод action="/contact/add" method="post"
